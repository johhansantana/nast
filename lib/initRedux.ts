...
let devtools = f => f;
if ((<any>process).browser && (<any>window).__REDUX_DEVTOOLS_EXTENSION__) {
  devtools = (<any>window).__REDUX_DEVTOOLS_EXTENSION__()
}

function create (apollo, initialState: Object = {}) {
  return createStore(
